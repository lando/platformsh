...
docker ps --filter label=com.docker.compose.project=landoplatformshmysql103 | grep docker.registry.platform.sh/mariadb-10.3 | grep landoplatformshmysql103_multi_1
