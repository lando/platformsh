Platform.sh MongoDB 3.0 Example
===============================

This example exists to test this plugin's implementation of Platform.sh's `mongodb:3.0` service.

* [`mongodb:3.0`](https://docs.platform.sh/configuration/services/mongodb.html)
...
docker ps --filter label=com.docker.compose.project=landoplatformshmongodb30 | grep docker.registry.platform.sh/php-7.3 | grep landoplatformshmongodb30_app_1
docker ps --filter label=com.docker.compose.project=landoplatformshmongodb30 | grep docker.registry.platform.sh/mongodb-3.0 | grep landoplatformshmongodb30_mongo_1
...
lando ssh -s mongo -c "mongod --version" | grep "db version" | grep "v3.0."
