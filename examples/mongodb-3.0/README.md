...
docker ps --filter label=com.docker.compose.project=landoplatformshmongodb30 | grep docker.registry.platform.sh/php-7.4 | grep landoplatformshmongodb30_app_1
