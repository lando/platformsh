Platform.sh MySQL 10.4 Example
================================
...
docker ps --filter label=com.docker.compose.project=landoplatformshmysql104 | grep docker.registry.platform.sh/mariadb-10.4 | grep landoplatformshmysql104_multi_1
