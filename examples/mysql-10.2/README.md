Platform.sh MySQL 10.2 Example
================================
...
docker ps --filter label=com.docker.compose.project=landoplatformshmysql102 | grep docker.registry.platform.sh/mariadb-10.2 | grep landoplatformshmysql102_multi_1
