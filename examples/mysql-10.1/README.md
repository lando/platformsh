...
docker ps --filter label=com.docker.compose.project=landoplatformshmysql101 | grep docker.registry.platform.sh/mariadb-10.1 | grep landoplatformshmysql101_multi_1
