Platform.sh MySQL 10.1 Example
================================

This example exists to test this plugin's implementation of Platform.sh's `mysql:10.1` service.

* [`mysql:10.1`](https://docs.platform.sh/configuration/services/mysql.html)
...
docker ps --filter label=com.docker.compose.project=landoplatformshmysql101 | grep docker.registry.platform.sh/mysql-10.1 | grep landoplatformshmysql101_mysql_1
docker ps --filter label=com.docker.compose.project=landoplatformshmysql101 | grep docker.registry.platform.sh/mysql-10.1 | grep landoplatformshmysql101_multi_1
